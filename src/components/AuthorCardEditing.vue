    ...
    >
        ...
        <div class="row">
            <q-input
                ...
                v-bind:error="givenNamesError != null"
                v-bind:error-message="givenNamesError"
        ...
        <div class="row">
            <q-input
                ...
                v-bind:error="nameParticleError != null"
                v-bind:error-message="nameParticleError"
            ...
            <q-input
                ...
                v-bind:error="familyNamesError != null"
                v-bind:error-message="familyNamesError"
            ...
            <q-input
                ...
                v-bind:error="nameSuffixError != null"
                v-bind:error-message="nameSuffixError"
        ...
        <div class="row">
            <q-input
                ...
                v-bind:error="affiliationError != null"
                v-bind:error-message="affiliationError"
...
export default defineComponent({
    ...
    setup (props) {
        ...
        return {
            givenNamesRef,
            givenNamesError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/given-names` })),
            nameParticleError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/name-particle` })),
            familyNamesError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/family-names` })),
            nameSuffixError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/name-suffix` })),
            emailError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/email` })),
            affiliationError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/affiliation` })),
            orcidError: computed(() => getMyErrors({ instancePath: `/authors/${props.index}/orcid` }))
        }
    },
