...
const getInitialData = () => {
    return {
        ...
        license: undefined,
        message: '',
        messagePlaceHolder: 'e.g. If you use this software, please cite it using the metadata from this file.',
...
export const useCff = () => {
    return {
        ...
        messagePlaceHolder: computed(() => cff.value.messagePlaceHolder),
        ...
        setMessagePlaceHolder: (newMessage: string) => { cff.value.messagePlaceHolder = newMessage },
